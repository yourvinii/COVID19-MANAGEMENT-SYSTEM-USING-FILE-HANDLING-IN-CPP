...
// COVID19 MANAGEMENT SYSTEM USING FILE HANDLING IN CPP - (vinayak developer)
...
void covid_management::menu()
{
    ...
    case 3:
        system("cls");
        cout << "\n\n\t\t\t COVID19 MANAGEMENT SYSTEM - BY VINAYAK DEVELOPER";
        Sleep(10);
        exit(0);
    default:
...
void covid_management::admin_password()
{
    ...
    cout << "\n\n\t\tEnter Valid Captcha: ";
    cin >> capta;
    if ((strcmp(a_name, "vinayak") == 0) && (strcmp(a_password, "4141") == 0) && (capt == capta))
    {
        cout << "\n\n\n\t\t\t\t\t| Verfiying ADMIN |\n\t\t\t\t\t";
        for (int a = 1; a < 8; a++)
        {
